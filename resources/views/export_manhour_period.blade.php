...
@section('title',__('msg.menu_export_manhour'))
...
<script src="{{ url('resources/assets') }}/app/export_manhour_period.js?q={{ time() }}"></script>
@endpush
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('msg.menu_export_manhour') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ __('msg.menu_dashboard')
                                }}</a></li>
                        <li class="breadcrumb-item active">{{ __('msg.menu_export_manhour') }}
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title">{{ __('msg.menu_export_manhour') }}</h3>
            ...
            <div class="card-body">
                <form action="{{ route('export.export-manhour-period') }}" method="POST" id="form-tranfer-daily"
                    target="_blank">
                    @csrf
                    <div class="row">
        ...
        <div class="modal-content">
            <form action="{{ route('export.export-manhour-period') }}" method="POST" id="form-tranfer-daily"
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Export Manhour Period</h5>
