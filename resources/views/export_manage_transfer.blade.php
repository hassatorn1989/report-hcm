...
<script src="{{ url('resources/assets') }}/app/export_manage_transfer.js?q={{ time() }}"></script>
@endpush
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-navy">
            ...
            <div class="card-body">
                <form action="{{ route('export.export-manage-transfer') }}" method="POST" id="form-tranfer-daily"
                    target="_blank">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
