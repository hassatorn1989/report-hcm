...
@section('title',__('msg.menu_pay_slip'))
@push('css')
...
<script src="{{ url('resources/assets') }}/app/pay_slip.js?q={{ time() }}"></script>
@endpush
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('msg.menu_pay_slip') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a
                                href="{{ route('dashboard.index') }}">{{ __('msg.menu_dashboard') }}</a></li>
                        <li class="breadcrumb-item active">{{ __('msg.menu_pay_slip') }}
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title">{{ __('msg.menu_pay_slip') }}</h3>
            ...
            <div class="card-body">
                <form action="{{ route('pay-slip.store') }}" method="post" id="form"
