...
@section('title', __('msg.menu_time_attendance'))
@push('css')
...
@push('script')
    ...
    <script src="{{ url('resources/assets') }}/app/time_attendance.js?q={{ time() }}"></script>
@endpush
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('msg.menu_time_attendance') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{ __('msg.menu_time_attendance') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="content">
            ...
            <div class="card card-navy">
                <div class="card-header">
                    <h3 class="card-title">{{ __('msg.menu_time_attendance') }} {{ __('msg.menu_report') }}</h3>
