...
@section('title',__('msg.menu_export_accrue_dailyCO'))
...
<script src="{{ url('resources/assets') }}/app/export_accrue_hour_co.js?q={{ time() }}"></script>
@endpush
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('msg.menu_export_accrue_dailyCO') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ __('msg.menu_dashboard')
                                }}</a></li>
                        <li class="breadcrumb-item active">{{ __('msg.menu_export_accrue_dailyCO') }}
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title">{{ __('msg.menu_export_accrue_dailyCO') }}</h3>
            ...
            <div class="card-body">
                <form action="{{ route('export.export-accrue-hour-co') }}" method="POST" id="form-tranfer-daily"
                    target="_blank">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="date_export" id="date_export"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <select class="custom-select" name="co_type" id="co_type">
                                    
                                    <option value="wtd">{{ __('msg.co_wtd') }}</option>
                                    <option value="all">{{ __('msg.co_all') }}</option>
                                </select>
                            </div>
                        </div>
                ...
                <table class="table table-sm" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th>Document Date(YYYYMMDD)</th>
                            <th>Posting Date(YYYYMMDD)</th>
                            <th>Document Text</th>
                            <th>Cost Center</th>
                            <th>SKF</th>
                            <th>Quantity</th>
