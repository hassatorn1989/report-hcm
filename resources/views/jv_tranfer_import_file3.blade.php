...
@push('script')
    ...
    <script src="{{ url('resources/assets') }}/app/jv_tranfer_import_file3.js?q={{ time() }}"></script>
@endpush
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ __('msg.menu_jv_tranfer_import_file3') }}</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="card card-navy">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('jv-tranfer.import-file3.store') }}" method="post" id="form"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="file_import" class="col-sm-2 col-form-label">AS400_TIME.XLS</label>
                            <div class="col-sm-8">
