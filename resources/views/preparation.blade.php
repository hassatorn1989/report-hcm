                    ...
                    <form action="" method="post" id="search-form">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="date" class="form-control" name="filter_dateCalculate"
                                    id="filter_dateCalculate" placeholder="Filter Date" value="" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <select class="custom-select" name="filter_OrgUnit" id="filter_OrgUnit">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="dateCalculate" id="dateCalculate"
                                        placeholder="{{ __('msg.placeholder') }}"
                                        value="{{ Request::get('dateCalculate') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="OrgUnit">Organize</label>
                                    <select class="custom-select" name="OrgUnit" id="OrgUnit">
                                        <option value="">{{ __('msg.select') }}</option>
                                        @if (!empty($OrgUnit))
                                            @foreach ($OrgUnit as $item)
                                                <option value="{{ $item->orgDivCode }}-{{ $item->orgDepCode }}">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-3 offset-md-9">
                                <button type="button" class="btn btn-primary btn-block" onclick="add_row()"> <i
