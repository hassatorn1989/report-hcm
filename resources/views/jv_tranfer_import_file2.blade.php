...
@section('title',__('msg.menu_jv_tranfer_import_file2'))
@push('css')
...
<script src="{{ url('resources/assets') }}/app/jv_tranfer_import_file2.js?q={{ time() }}"></script>
@endpush
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('msg.menu_jv_tranfer_import_file2') }}</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ __('msg.menu_dashboard')
                                }}</a></li>
                        <li class="breadcrumb-item active">{{ __('msg.menu_jv_tranfer_import_file2') }}
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <section class="content">
        ...
        <div class="card card-navy">
            <div class="card-header">
                <h3 class="card-title">{{ __('msg.menu_jv_tranfer_import_file2') }}</h3>
            ...
            <div class="card-body">
                <form action="{{ route('jv-tranfer.import-file2.store') }}" method="post" id="form"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="file_import" class="col-sm-2 col-form-label">AS400_DEP.XLS</label>
                        <div class="col-sm-8">
